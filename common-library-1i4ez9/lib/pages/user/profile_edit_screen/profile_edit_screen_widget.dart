...
import 'profile_edit_screen_model.dart';
export 'profile_edit_screen_model.dart';

class ProfileEditScreenWidget extends StatefulWidget {
  const ProfileEditScreenWidget({super.key});
...
class _ProfileEditScreenWidgetState extends State<ProfileEditScreenWidget> {
  late ProfileEditScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileEditScreenModel());
